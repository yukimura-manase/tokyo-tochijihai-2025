...
import { Sheet, SheetContent, SheetHeader, SheetTitle } from '@/components/shared/ui-elements/sheet';
                  ...
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        <span className={`inline-block px-2 py-1 text-xs rounded-full ${getFacilityColor(facility.type)}`}>
